...
const BASE_CONTENT = {
  ...
  trabalhos: [
    { nome: 'Youtuber', min: 50, max: 250, emoji: '📹' },
    { nome: 'Programador', min: 100, max: 300, emoji: '💻' },
    { nome: 'Designer', min: 75, max: 225, emoji: '🎨' },
    { nome: 'Streamer', min: 50, max: 350, emoji: '🎮' },
    { nome: 'Gamer Profissional', min: 150, max: 400, emoji: '🎯' },
    { nome: 'Entregador', min: 25, max: 100, emoji: '🏍️' },
    { nome: 'Chef de Cozinha', min: 90, max: 275, emoji: '👨‍🍳' },
    { nome: 'Músico', min: 60, max: 240, emoji: '🎵' },
    { nome: 'Fotógrafo', min: 70, max: 260, emoji: '📸' },
    { nome: 'Personal Trainer', min: 80, max: 270, emoji: '💪' },
    { nome: 'Barista', min: 45, max: 175, emoji: '☕' },
    { nome: 'Motorista de Uber', min: 55, max: 210, emoji: '🚗' },
    { nome: 'Vendedor', min: 65, max: 245, emoji: '💼' },
    { nome: 'Mecânico', min: 85, max: 280, emoji: '🔧' },
    { nome: 'Eletricista', min: 95, max: 290, emoji: '⚡' },
    { nome: 'Encanador', min: 90, max: 285, emoji: '🔨' },
    { nome: 'Jardineiro', min: 50, max: 190, emoji: '🌱' },
    { nome: 'Pintor', min: 60, max: 220, emoji: '🎨' },
    { nome: 'Segurança', min: 75, max: 250, emoji: '🛡️' },
    { nome: 'Recepcionista', min: 55, max: 205, emoji: '📋' },
    { nome: 'Garçom', min: 48, max: 185, emoji: '🍽️' },
    { nome: 'Bartender', min: 65, max: 235, emoji: '🍹' },
    { nome: 'DJ', min: 100, max: 325, emoji: '🎧' },
    { nome: 'Tatuador', min: 110, max: 340, emoji: '🎨' },
    { nome: 'Barbeiro', min: 70, max: 255, emoji: '✂️' }
  ],
